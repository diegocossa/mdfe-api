                                                    ...
                                                    <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td align="center" valign="top" class="textContent">
                                                                <h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">Dados para Acesso</h1>
                                                                <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;" text="'Olá, '+${nome}"></h2>
                                                                <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">Seja bem-vindo ao 3G Brasil MDF-e, seus dados de acesso estão logo abaixo.</div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- // CONTENT TABLE -->
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" width="90" style="max-width:100%;">
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            <img src="https://s3-us-west-2.amazonaws.com/dvcondominio/DATAVOID/img_296750.png" width="73" class="flexibleImageSmall" style="max-width:100%;" alt="" title="" />
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="flexibleContainer">
                                                        <tr>
                                                            <td align="left" valign="top" class="textContent">
                                                                <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:10px;color:#5F5F5F;line-height:135%;">Para realizar o seu primeiro acesso é só informar os dados acima, e-mail e senha. Clique aqui <a href="http://www.3gbrasil.com.br/sessions/signin" target="_blank">acessar site</a>.</div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- // CONTENT TABLE -->
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    <tr>
                                                                        <td valign="top" class="textContent">
                                                                            <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">Em caso de qualquer dúvida, fique à vontade para nos contatar por meio do email suporte@datavoid.com.br.
                                                                                DataVoid</div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                        ...
                                                        <tr>
                                                            <td valign="top" bgcolor="#E1E1E1">
                                                                ...
                                                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                    <div>Copyright &#169; <a href="http://www.3gbrasil.com.br/contato/" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">3G Brasil MDF-e</span></a>. Todos os&nbsp;direitos&nbsp;reservados.</div>
                                                                </div>
