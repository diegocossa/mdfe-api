...
@Configuration
public class ConexaoMDFeConfig extends MDFeConfig {
    ...
    public ConexaoMDFeConfig configurar() {
...
//            try (InputStream certificadoStream = new FileInputStream(local+"/certificado/EDJOTRANSPORTES ARAUJO LTDA00580560000162.pfx")) {
